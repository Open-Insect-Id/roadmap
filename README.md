...
- [❌] Création d'une appli de test en kotlin (plus facile) qui servira de solution de secour si nous n'arrivons pas à créer d'application android avec kivi ou d'application pour ordinateur
